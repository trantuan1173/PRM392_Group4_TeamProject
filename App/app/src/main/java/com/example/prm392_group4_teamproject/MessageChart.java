...
public class MessageChart extends AppCompatActivity {
        ...
        call.enqueue(new Callback<UserResponse>() {
            ...
            public void onResponse(Call<UserResponse> call, Response<UserResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    // ✅ Chỉ khởi tạo adapter sau khi có userId
                    ...
                    Toast.makeText(MessageChart.this, "Không lấy được thông tin người dùng", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<UserResponse> call, Throwable t) {
                Toast.makeText(MessageChart.this, "Lỗi khi lấy profile: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        call.enqueue(new Callback<MatchDetailResponse>() {
            ...
            public void onResponse(Call<MatchDetailResponse> call, Response<MatchDetailResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(MessageChart.this, "Không tìm thấy match", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<MatchDetailResponse> call, Throwable t) {
                Toast.makeText(MessageChart.this, "Lỗi mạng: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        call.enqueue(new Callback<MessageListResponse>() {
            ...
            public void onResponse(Call<MessageListResponse> call, Response<MessageListResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(MessageChart.this, "Không tải được tin nhắn", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<MessageListResponse> call, Throwable t) {
                Toast.makeText(MessageChart.this, "Lỗi tải tin nhắn", Toast.LENGTH_SHORT).show();
            }
        });
    }

...
import com.example.prm392_group4_teamproject.adapters.MessageListAdapter;
import com.example.prm392_group4_teamproject.adapters.NewMatchAdapter;
...
public class MessageActivity extends AppCompatActivity {
    ...
    private void loadMatches() {
        UserApi userApi = ApiClient.getClient().create(UserApi.class);
        Call<MatchResponse2> call = userApi.getMatches2(token, 1, 50);

        call.enqueue(new Callback<MatchResponse2>() {
            @Override
            public void onResponse(@NonNull Call<MatchResponse2> call, @NonNull Response<MatchResponse2> response) {
                if (response.isSuccessful() && response.body() != null) {
            ...
            @Override
            public void onFailure(Call<MatchResponse2> call, Throwable t) {
